...
kill @e[tag=portal,tag=second,tag=external_resonance]
playsound nyctocosm:portal.external_resonance.collapse.second master @a[distance=..100] ~ ~ ~ 50
execute as @a[distance=..50] at @s run function nyctocosm:portal/__generated__/block/57