...
scoreboard players operation subtrahend value *= @s m.dream.speed
...
scoreboard players operation @s m.spell.power += @s m.dream.power
execute as @s[tag=!tellrawed] if score DisplayCastMessage value matches 1 run function spells:transmittance/__generated__/block/402