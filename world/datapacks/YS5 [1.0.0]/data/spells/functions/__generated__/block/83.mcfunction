...
execute at @s as @e[distance=..3,tag=spell,tag=reflector] run function spells:__generated__/block/84
execute at @s if entity @e[tag=spell,tag=!matchedid,tag=reflector,distance=..3] run function spells:__generated__/block/86
...
execute at @s as @e[type=#nyctocosm:livingthings,distance=..3] at @s run function spells:__generated__/block/89
function spells:__generated__/block/90
execute at @s if entity @e[type=#nyctocosm:livingthings,distance=..3] run kill @s
execute as @e[tag=Incandescence,tag=particle_emitter,tag=matchedid] at @s run function spells:__generated__/block/91