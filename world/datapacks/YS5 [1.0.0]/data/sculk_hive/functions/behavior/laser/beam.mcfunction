...
execute positioned ~-1.75 ~-1 ~-1.75 as @e[tag=sh_atk, dx=2.5, dz=2.5, dy=1] at @s run effect give @s darkness 3 0 true
...
execute positioned ~-1.75 ~-1 ~-1.75 as @e[tag=sh_atk, dx=2.5, dz=2.5, dy=1] at @s run effect give @s slowness 3 1
