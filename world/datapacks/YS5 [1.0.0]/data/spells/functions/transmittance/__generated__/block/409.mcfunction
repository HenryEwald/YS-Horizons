...
scoreboard players operation subtrahend value *= @s m.void.speed
...
scoreboard players operation @s m.spell.power += @s m.void.power
execute as @s[tag=!tellrawed] if score DisplayCastMessage value matches 1 run function spells:transmittance/__generated__/block/410