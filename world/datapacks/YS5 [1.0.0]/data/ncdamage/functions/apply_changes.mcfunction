...
execute unless score @s ncd_bypsresef matches 1.. if data entity @s ActiveEffects[{Id:11}] run function ncdamage:internals/calculate_defense/resistance_effect
