...
execute if score @s UUID0 = UUID0 value if score @s UUID1 = UUID1 value if score @s UUID2 = UUID2 value if score @s UUID3 = UUID3 value run function spells:__generated__/block/48