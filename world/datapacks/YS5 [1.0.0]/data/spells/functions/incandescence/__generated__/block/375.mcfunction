...
scoreboard players operation subtrahend value *= @s m.dissonance.speed
...
scoreboard players operation @s m.spell.power += @s m.dissonance.power
execute as @s[tag=!tellrawed] if score DisplayCastMessage value matches 1 run function spells:incandescence/__generated__/block/376