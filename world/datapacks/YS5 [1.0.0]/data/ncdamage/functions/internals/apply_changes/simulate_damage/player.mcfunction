...
execute unless score #donotsimulatesound ncd_options matches 1.. unless score #hurttime ncd.temp matches 0..1 as @s anchored eyes run function ncdamage:internals/apply_changes/simulate_damage/player/sound
