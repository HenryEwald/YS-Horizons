...
execute at @s as @e[distance=..3,tag=spell,tag=reflector] run function spells:__generated__/block/105
execute at @s if entity @e[tag=spell,tag=!matchedid,tag=reflector,distance=..3] run function spells:__generated__/block/107
...
execute at @s as @e[type=#nyctocosm:livingthings,distance=..3] at @s run function spells:__generated__/block/110
execute at @s if entity @e[type=#nyctocosm:livingthings,distance=..3] run kill @s
execute as @e[tag=Incandescence,tag=particle_emitter,tag=matchedid] at @s run function spells:__generated__/block/111