...
scoreboard players operation Rot1 value %= #45 rng
scoreboard players add Rot1 value 0
scoreboard players remove Rot1 value 23
...
execute at @s run function effects:void_swirl/__generated__/block/51
